...
function Order() {
  ...
  const update_stutes = (order_id, stutes)=> {
          ...
          <div className="p-1.5 min-w-full inline-block align-middle">
            ...
            <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                          <button type="button" className="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-green-600 hover:text-blue-800 focus:outline-none focus:text-green-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-green-400 dark:focus:text-green-400">{user.Address}</button>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-pink-800 dark:text-neutral-200">{x1[user.Status]}</td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">
                         ...
                         <Link to={`/Admin/Order/Order_detail/${user.Id}`}className="border-0 outline-0 text-green-600 border-2 rounded-sm border-green-400 px-1">Show detail</Link>
                        </td>
                      </tr>
          ))}
      </tbody>
