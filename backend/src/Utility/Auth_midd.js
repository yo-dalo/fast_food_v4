...
function checkCookieAuth_Admin(req, res, next) {
    const authCookie = req.cookies.authToken_admin; // Replace 'authToken' with your cookie name
//console.log(req.cookies)
    if (!authCookie) {
        return res.status(401).json({ login: false });
    }
...
module.exports = {checkCookieAuth,checkCookieAuth_Admin};